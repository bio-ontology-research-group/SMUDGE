...
x_train, x_test, y_train, y_test = train_test_split(data_pairs, labels, test_size=0.2, random_state=1)
...
np.savetxt('smudge_results/classifer_rank_logit_smudge.txt', auc_data, fmt = '%s')
